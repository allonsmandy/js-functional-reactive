...
function removeIfHaveNumber(array) {
  return array.filter(element => {
    const number = parseInt(element.trim())  // generates numeric value or NaN if not numeric 
    return number !== number // will be true when the result of number is equal to NaN
  })
}
